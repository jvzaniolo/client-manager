<?php $this->layout('layout', ['title' => 'Registrar - KaBuM!']) ?>
...
<main class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
  <div class="sm:mx-auto sm:w-full sm:max-w-sm">
    ...
    <h2 class="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900 dark:text-white">Crie sua
      conta
    </h2>
  </div>
